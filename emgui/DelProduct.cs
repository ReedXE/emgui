    ...
    public partial class DelProduct : Form
    {
        ...
        private void wypelnijTabeleProduktyDanymi()
        {
            using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.store_dbConnectionString))
            {
                ...
                const string sql = "Select idProduct, idStore, ProductName, Type, Price, modelNumber FROM Product";
                ...
                using (SqlCommand sqlCommand = new SqlCommand(sql, connection))
                {
                    ...
                    try
                    {
                        ...
                        using (SqlDataReader dataReader = sqlCommand.ExecuteReader())
                        {
                            ...
                            this.dgvDelProduct.DataSource = dataTable;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                from wiersz in repozytorium.Product
                where wiersz.idProduct == System.Convert.ToInt32(dgvDelProduct.SelectedRows[0].Cells[0].Value.ToString())
                select wiersz;
                ...
                {
                    repozytorium.Product.DeleteOnSubmit(wiersz);
                }
