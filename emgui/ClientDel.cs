    ...
    public partial class ClientDel : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                from wiersz in repozytorium.Client
                where wiersz.idClient == System.Convert.ToInt32(dgvDelClient.SelectedRows[0].Cells[0].Value.ToString())
                select wiersz;
                ...
                {
                    repozytorium.Client.DeleteOnSubmit(wiersz);
                }
                ...
                using (SqlCommand sqlCommand = new SqlCommand(sql, connection))
                {
                    ...
                    try
                    {
                        ...
                        using (SqlDataReader dataReader = sqlCommand.ExecuteReader())
                        {
                            ...
                            this.dgvDelClient.DataSource = dataTable;
